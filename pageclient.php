...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  <div class="item">
		  <div class="container">
			<a href="#login" data-toggle="modal" > <img style="width:100%" src="themes/images/carousel/12.jpg" alt=""/></a>
				
		  </div>
		  </div>
		   <div class="item">
		   <div class="container">
			<a  href="#login" data-toggle="modal" ><img src="themes/images/carousel/14.jpg" alt=""/></a>
		   ...
		   <div class="item">
		   <div class="container">
			<a  href="#login" data-toggle="modal" ><img src="themes/images/carousel/15.jpg" alt=""/></a>
	...
	<div class="row">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> ELECTRONICS</a>
				<ul>
				<li><br></li>
				<li><a href="Cameras.php"><i class="icon-chevron-right"></i>Cameras</a></li>
				<li><br></li>
				<li><a href="Computers.php"><i class="icon-chevron-right"></i>Computers</a></li>
				<li><br></li>
				<li><a href="mobliephone.php"><i class="icon-chevron-right"></i>Mobile Phone </a></li>
				<li><br></li>
              ...
              foreach ($latestproduct as $latestproduct) {
                 ...
                 echo '
				  ...
				  <div class="caption">
					  ...
					  <h4 style="text-align:center"> price :'.$latestproduct["price"].' </a></h4>

	                   <a href="#buynow" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-primary ">buy now </span></a>
	       <div id="buynow" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="false" >
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			<h3>Login </h3>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal loginFrm" action="buynow.php" method="POST" >
			  <div class="control-group">
			    <label for="inputname">MASTER CARTE</label>
			...
			<input type="submit" value="BUY" class="btn btn-success" required/>
			</form>
